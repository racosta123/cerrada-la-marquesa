# Cerrada La Marquesa — PWA de control de acceso
...
## Despliegue (resumen)
1. **Firebase**: crea proyecto `cerrada-la-marquesa`. Activa Auth (correo/contraseña), Firestore, Cloud Messaging.
...
6. **GitHub Pages**: sube todo al repo `racosta123/cerrada-la-marquesa`, activa Pages.
